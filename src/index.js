function refreshWeather(response) {
  ...
  let condittionsElement = document.querySelector("#conditions");
  condittionsElement.innerHTML = response.data.condition.description;
  ...
  let date = new Date(response.data.temperature.time * 1000);
